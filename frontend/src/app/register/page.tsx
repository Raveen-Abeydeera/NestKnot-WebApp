...
export default function RegisterPage() {
  ...
  return (
    <div className="flex justify-center items-center py-xl w-full">
      ...
      >
        <h1 className="font-headline-md text-primary text-center mb-sm">Create Account</h1>
        <p className="font-body-md text-on-surface-variant text-center mb-lg">
          Join NestKnot to post service requests.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-lg">
          ...
          <div className="space-y-xs">
            ...
            <p className="font-body-sm text-on-surface-variant text-xs mt-1">Must be at least 6 characters.</p>
          </div>
